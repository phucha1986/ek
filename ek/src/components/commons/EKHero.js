    ...
    <div className="js-hero">
      <div data-tcm-id="" analytic-text="" style={{position: 'relative',width: '100%'}} className="hero">
        <div style={{position: 'absolute',width: '100%'}} className="hero__backdrop">
          <picture className="hero__image--background"><source media="(min-width: 1024px)" srcset="https://c.ekstatic.net/ecl/people/outdoors/flora-park-sightseeing-lavander-flower-at-kuyucak-w1920x480.jpg?h=W-HI5sr3dIF7f3pUW207jQ"/>
