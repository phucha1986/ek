    ...
    <div id={params.ID} role="combobox" aria-owns="auto-suggest_1_list" aria-expanded="true" aria-haspopup="true" onBlur={onDropdownBlur} onClick={onDropdownFocus}>
      ...
      <span className="input-field input-field--active">
        <span className="input-field__field">
          <input aria-labelledby="auto-suggest_1_label" className="input-field__input ellipsis" aria-describedby="auto-suggest_1_aria-described-by" id="auto-suggest_1" aria-autocomplete="list" aria-controls="auto-suggest_1_list" type="text" autocomplete="off" value={`${selectedItem.City}(${selectedItem.AirportCode})`}/>
        </span>
